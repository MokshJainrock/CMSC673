...
class SearchTests(unittest.TestCase):
    ...
    def test_tokenization_is_case_insensitive(self):
        ...
        self.assertNotIn("is", tokenize("mathematics is hard"))
    ...
    def test_math_query_returns_math_section(self):
        top = self.engine.search("mathematics is hard", k=1)[0]
        self.assertEqual(top.doc_id, "algebra_01_01_problem_solving")
